...
<form action="{{route('cidades.store')}}" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="formGroupExampleInput" name="nome" placeholder="Digite o nome da cidade para ser cadastrada" value="{{old('nome')}}" required>
    </div>
    <div class="row">
        ...
        <div class="col">
          ...
          <input type="text" class="form-control" name="cep" placeholder="Digite o CEP da cidade para ser cadastrada" value="{{old('cep')}}"  required>
        </div>
      </div>
      <br><br>
